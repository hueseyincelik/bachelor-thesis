...
\captionsetup{belowskip=0pt}
	...
	\label{fig:EH-biased}
\end{figure}
A subsequent Fourier transformation of the electron hologram $I_{hol}\left(\vb{r}\right)$ yields \cite{Lehmann1994,Voelkl1995}:
\begin{equation}
	\label{eq:FT-bands}
	\begin{split}
...
\begin{figure}[H]
	\centering
	\input{Figures/Schematics/EH-Setup.tikz}%
...
\begin{figure}[H]
	\centering
	\input{Figures/Schematics/Interference-Gating.tikz}%
...
Along with the Fourier transformation, there exists an inverse Fourier transformation, resulting in a Fourier transform pair, defined as \cite{rahman2011,kaiser2011}:
\begin{equation}
